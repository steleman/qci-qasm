...
ASTExitStatementNode*
ASTBuilder::CreateASTExitStatementNode(const ASTIdentifierNode* Id) {
  assert(Id && "Invalid ASTIdentifierNode argument!");

  ASTExitStatementNode* EX = new ASTExitStatementNode(Id);
  assert(EX && "Could not create a valid ASTExitStatementNode!");
  return EX;
}
